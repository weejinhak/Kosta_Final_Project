		...
		<div class="col-md-12">
			...
			<div class="box box-primary">
				...
				<form role="form" action="modifyPage" method="post">
					...
					<input type='hidden' name='bno' value="${boardVO.lectureNo}"> <input
				...
				<div class="box-body">
					<div class="form-group">
						<label for="exampleInputEmail1">Title</label> <input type="text"
							name='title' class="form-control" value="${boardVO.lectureTitle}"
							readonly="readonly">
					</div>
					<div class="form-group">
						<label for="exampleInputPassword1">Content</label>
						<textarea class="form-control" name="content" rows="3"
							readonly="readonly">${boardVO.lectureContent}</textarea>
					</div>
					<div class="form-group">
						<label for="exampleInputEmail1">Writer</label> <input type="text"
							name="writer" class="form-control" value="${boardVO.lectureDate}"
							readonly="readonly">
					</div>
				</div>
				<!-- /.box-body -->
